...
fig_a <- fig_a +
     inset_element(table_a, 0.95, 0.7, 0.4, 0.95)
...
fig_c <- fig_c +
     inset_element(table_c, 0.95, 0.7, 0.4, 0.95)
...
fig_e <- fig_e +
     inset_element(table_e, 0.95, 0.7, 0.4, 0.95)
...
fig_b <- fig_b +
        inset_element(table_b, 0.95, 0.7, 0.4, 0.95)
...
fig_d <- fig_d +
        inset_element(table_d, 0.95, 0.7, 0.4, 0.95)
...
fig_f <- fig_f +
        inset_element(table_f, 0.95, 0.7, 0.4, 0.95)


# combined plot -----------------------------------------------------------

fig <- fig_a + fig_b + fig_c + fig_d + fig_e + fig_f + plot_layout(guides = 'collect', ncol = 2) &
