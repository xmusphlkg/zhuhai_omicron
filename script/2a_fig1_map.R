...
ggsave(filename = './outcome/publish/extend/Figure 1.pdf',
       fig_map,
       width = 7, height = 6, device = cairo_pdf)

ggsave(filename = './outcome/publish/extend/Figure 1.png',
       fig_map,
       width = 7, height = 6)

ggsave(filename = './outcome/publish/extend/Figure 1.tiff',
       fig_map,
       width = 7, height = 6)
