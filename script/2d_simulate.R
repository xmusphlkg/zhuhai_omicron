...
for (x in 1:3) {
  ...
  assign(paste0('fig_temp_', x*2-1), fig)
}

fig_temp_1 / fig_temp_3 / fig_temp_5
...
for (x in 1:3) {
  ...
  assign(paste0('fig_temp_', x*2), fig)
}

# plot combind ------------------------------------------------------------

(fig_temp_1 + fig_temp_2)/
  (fig_temp_3 + fig_temp_4)/
  (fig_temp_5 + fig_temp_6)+
  plot_layout(guides = 'collect')&
  theme(legend.position = 'bottom')

ggsave(filename = './outcome/science/Figure 4.pdf', 
       device = cairo_pdf, height = 15, width = 12)

ggsave(filename = './outcome/science/Figure 4.tiff', 
       height = 15, width = 12,
       dpi = 300)

ggsave(filename = './outcome/science/Figure 4.png', 
       height = 15, width = 12,
       dpi = 300)
